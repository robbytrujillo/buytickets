...
<body>
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-[#F8F8F9]">
        <div id="background" class="fixed w-full max-w-[640px] top-0 h-screen z-0">
            ...
            <img src="{{Storage::url($bookingTransaction->ticket->thumbnail)}}" class="object-cover w-full h-full" alt="background">
        </div>
        ...
        <div class="relative flex items-center justify-center flex-1 w-full h-full p-4 mt-5">
            <div class="flex flex-col h-fit w-full max-w-[361px] rounded-[30px] p-5 gap-6 bg-white">
                ...
                <h1 class="text-2xl font-bold leading-9 text-center">Booking Finished, <br>Well Done! 🤩</h1>
                <a href="{{ route('front.check_booking') }}">
                    <div class="flex items-center w-full rounded-full transition-all duration-300 hover:ring-1 hover:ring-[#F97316] py-3 px-4 gap-4 bg-[#F8F8F9]">
                        <img src="{{asset('assets/images/icons/receipt-text.svg')}}" class="flex w-8 h-8 shrink-0" alt="icon">
