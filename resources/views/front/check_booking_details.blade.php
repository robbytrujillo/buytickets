                ...
                <div class="relative flex flex-col p-5 pb-[30px] gap-6">
                    ...
                    <div class="flex flex-col gap-[14px] shrink-0 h-full">
                        <div class="flex items-center justify-between">
                            ...
                            <p class="font-bold text-xl leading-[30px]">JRT19039</p>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="font-bold text-sm leading-[21px]">Started At</p>
                            <p class="font-bold text-sm leading-[21px] text-[#FF1927]">11 July 2025</p>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="font-bold text-sm leading-[21px]">Total People</p>
                            <p class="font-bold text-sm leading-[21px]">2 Participant</p>
                        </div>
                        <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="font-bold text-[22px] leading-[33px] text-[#F97316]">Rp 189.000.000</p>
                        </div>
                        <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center rounded-[20px] p-[10px] gap-[10px] bg-[#F8F8F9]">
                        ...
                        <p class="leading-[28px]">Gunakan kode <span class="font-bold">JRT19039</span> ketika menukarkan dengan tiket asli</p>
                    </div>
                </div>
            </div>
        </main>
